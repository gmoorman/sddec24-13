...
C {devices/vsource.sym} -300 -290 0 0 {name=V2 value=0.6 savecurrent=false}
...
.control
 ...
 plot x1.VoutplusB x1.VoutminusB
 plot Vin CLK
 plot Vin
...
C {devices/vsource.sym} -600 -350 0 0 {name=V1 value="pwl(0 0 1u 1.2"
