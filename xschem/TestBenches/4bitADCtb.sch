...
C {devices/vsource.sym} -1240 -210 0 0 {name=V4 value="pwl(0 0 2u 1)" savecurrent=true}
...
let VinD = Vin * 16
plot VinD
let dout = out0*0.0625+out1*0.125+out2*0.1875+out3*0.25
plot dout
plot  AnalogOut Vin
plot Vsample Vbuff
let INL = Vin - dout
...
C {devices/sqwsource.sym} -1110 -210 0 0 {name=V2 vhi=1.8 freq=40e6}
...
C {devices/code.sym} -1180 335 0 0 {name=STDCELLS
only_toplevel=false
...
C {devices/gnd.sym} -1410 -370 0 1 {name=l4 lab=GND}
...
C {devices/gnd.sym} 1040 255 0 1 {name=l2 lab=GND}
C {devices/vccs.sym} 160 -175 0 0 {name=G1 value=62.5e-6}
C {devices/vccs.sym} 360 -175 0 0 {name=G2 value=125e-6}
C {devices/vccs.sym} 530 -175 0 0 {name=G3 value=187.5e-6}
C {devices/vccs.sym} 690 -175 0 0 {name=G4 value=250e-6}
C {devices/gnd.sym} 120 -195 0 0 {name=l7 lab=GND}
C {devices/gnd.sym} 320 -195 0 0 {name=l8 lab=GND}
C {devices/gnd.sym} 490 -195 0 0 {name=l9 lab=GND}
C {devices/gnd.sym} 650 -195 0 0 {name=l11 lab=GND}
C {devices/vcvs.sym} 860 5 0 0 {name=E1 value=1e6}
C {devices/gnd.sym} 820 -15 1 0 {name=l12 lab=GND}
C {devices/res.sym} 850 135 1 0 {name=R3
value=1k
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 860 35 0 0 {name=l13 lab=GND}
C {devices/gnd.sym} 455 -305 2 0 {name=l14 lab=GND}
C {devices/lab_pin.sym} 990 50 2 0 {name=p13 sig_type=std_logic lab=AnalogOut}
C {devices/lab_pin.sym} 90 -155 0 0 {name=p5 sig_type=std_logic lab=out0}
C {devices/lab_pin.sym} 280 -155 0 0 {name=p19 sig_type=std_logic lab=out1}
C {devices/lab_pin.sym} 455 -155 0 0 {name=p21 sig_type=std_logic lab=out2}
C {devices/lab_pin.sym} 650 -155 0 0 {name=p22 sig_type=std_logic lab=out3}
