...
C {devices/ipin.sym} -180 560 2 0 {name=p4 lab=Vb1}
C {devices/ipin.sym} 140 580 1 0 {name=p6 lab=Vb2}
C {devices/ipin.sym} 150 670 1 0 {name=p5 lab=Vb3}
C {devices/lab_pin.sym} 400 730 2 0 {name=p7 sig_type=std_logic lab=VSS}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} 390 690 3 0 {name=R1
L=1.1
