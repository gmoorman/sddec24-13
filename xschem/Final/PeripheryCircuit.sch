...
C {Amplifiers/2stageOpamp.sym} -1235 -20 0 0 {name=x1}
C {devices/lab_pin.sym} -1225 -190 1 0 {name=p6 sig_type=std_logic lab=VDD}
C {DataConverters/4bitADC.sym} -70 250 0 0 {name=x2}
C {DataConverters/Priority_Encoder_16t4.sym} 270 70 0 0 {name=x3 prefix=sky130_fd_sc_hd__ }
C {sky130_fd_pr/res_high_po_0p35.sym} -1165 -150 1 0 {name=R1
L=2.45
...
C {sky130_fd_pr/res_high_po_0p35.sym} -1670 60 0 0 {name=R2
L=0.35
model=res_high_po_0p35
spiceprefix=X
mult=1}
C {devices/gnd.sym} -1165 -170 2 0 {name=l1 lab=GND}
C {sky130_fd_pr/res_high_po_0p35.sym} -1670 190 0 0 {name=R3
L=0.35
model=res_high_po_0p35
spiceprefix=X
mult=1}
...
C {StandardCells/inverter.sym} -850 210 3 0 {name=x5}
...
C {Amplifiers/2stageOpamp.sym} -605 -50 0 0 {name=x4}
C {StandardCells/TransmissionGate.sym} -795 -30 2 1 {name=x7}
C {sky130_fd_pr/cap_mim_m3_2.sym} -725 0 0 0 {name=C2 model=cap_mim_m3_2 W=5 L=5 MF=10 spiceprefix=X}
C {devices/ipin.sym} -1380 -375 0 0 {name=p18 lab=VSS}
C {devices/lab_pin.sym} -1225 20 3 0 {name=p24 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -595 -140 1 0 {name=p20 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -595 30 3 0 {name=p25 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 60 -100 0 0 {name=p26 sig_type=std_logic lab=VSS}
