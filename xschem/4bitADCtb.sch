...
C {sky130_fd_pr/corner.sym} -1610 260 0 0 {name=SPICE only_toplevel=true corner=tt}
...
C {devices/launcher.sym} -1530 190 0 0 {name=h3
descr="Netlist & sim" 
tclcommand="xschem netlist; xschem simulate"}
C {devices/lab_pin.sym} -1230 -20 0 1 {name=p43 sig_type=std_logic lab=VDD}
C {devices/code_shown.sym} -1340 170 0 0 {name=SPICE1
only_toplevel=false 
value="
.control
save all
...
C {Priority_Encoder_16t4.sym} -410 -390 0 0 {name=x2 prefix=sky130_fd_sc_hd__ }
C {devices/code.sym} -1480 270 0 0 {name=STDCELLS
only_toplevel=true
...
C {4bitADC.sym} -750 -210 0 0 {name=x1}
