...
C {sky130_fd_pr/res_xhigh_po.sym} -145 250 0 1 {name=R1
W=1
L=10
model=res_xhigh_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po.sym} -25 250 0 0 {name=R2
W=1
L=10
model=res_xhigh_po
spiceprefix=X
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -165 170 0 0 {name=M11
L=1
W=5
nf=1
mult=4
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -5 170 0 1 {name=M12
L=1
W=5
nf=1
mult=4
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -335 0 0 1 {name=M13
L=1
W=5
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -105 0 0 0 {name=M14
L=1
W=5
nf=1
mult=10
