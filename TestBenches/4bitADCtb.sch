...
C {devices/vsource.sym} -1240 -210 0 0 {name=V4 value="sin(0.5 0.5 1e6 0)" savecurrent=true}
...
C {devices/sqwsource.sym} -1110 -210 0 0 {name=V2 vhi=1.8 freq=4M}
...
C {xschem/Ideal/IdealDAC.sym} 200 -520 0 0 {name=x3}
