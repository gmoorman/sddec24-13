...
C {devices/gnd.sym} 0 -10 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} -300 -60 0 1 {name=p7 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 0 -170 3 1 {name=p8 sig_type=std_logic lab=VDD}
...
C {devices/gnd.sym} -30 -400 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} -30 -550 3 1 {name=p10 sig_type=std_logic lab=VDD}
...
C {dependencies/pdks/sky130B/libs.tech/xschem/userLib/5TwithBuffer.sym} -40 -480 0 0 {name=x2}
C {dependencies/pdks/sky130B/libs.tech/xschem/userLib/5TOpamp.sym} -190 -100 0 0 {name=x1}
